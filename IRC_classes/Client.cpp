...
Client::Client(int s)
    : socket(s), passwordEntered(false), passwordAttempts(3), nickname(""), username(""), inputBuffer(""), outputBuffer("") {}

Client::Client()
    : socket(-1), passwordEntered(false), passwordAttempts(3), nickname(""), username(""), inputBuffer(""), outputBuffer("") {}
